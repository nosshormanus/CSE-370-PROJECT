...
<br>
   ...
   <table width="100%">
	...
	echo "database is not connected properly please try again";
}
	$conn-> close();
			?>
		...
		<form action="G3_usercontroll.php" class="form_design" method="post">
		   
			<input type="submit" value="Back to user manage page">
		</form>
	...
	<form action="G3_Selectaction.php" class="form_design" method="post">
		   
			<input type="submit" value="Back to Select action page">
		</form>
