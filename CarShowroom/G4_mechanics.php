...
<nav>
	...
	<li><a href="G4_mechanics.php">Mechanics</a></li>
  ...
  <section id = "section1">
		...
		<div class="title">Submit Your CV Here to get the job</div>
		...
		<form action="#" class="form_design" method="post">
			...
			Maritial Status: <input type="text" name="sex"> <br/>
			Religion: <input type="text" name="rel"> <br/>
			Skills: <input type="text" name="skill"> <br/>
			Education: <input type="text" name="edu"> <br/>
			Past experiences: <input type="text" name="past"> <br/>
